                ...
                <div className="neuro-box">
                  ...
                  <div className="neuro-box neuro-box--inner">
                    ...
                    <div className="neuro-muted">
                      Программа подбирается индивидуально после первичного знакомства и запроса
                      семьи. Если ребёнок уже наблюдается у профильных специалистов, занятия
                      выстраиваются с учётом их рекомендаций.
                    </div>
                  </div>
                </div>
              </div>
